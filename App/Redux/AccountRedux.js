...
export const isLoggedIn = accountState =>  accountState.account !== null ? true:false;


export const getLogin = accountState =>
  accountState.account !== null ? accountState.account.login : 'anonymousUser';
